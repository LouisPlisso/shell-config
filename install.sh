...
for file in profile inputrc vimrc gvimrc Xdefaults xmonad xmobarrc cabal XCompose keynavrc dircolors lxdvdrip.conf abcde.conf vimperator vim vimperator/vimperatorrc vimperator/muttatorrc; do
