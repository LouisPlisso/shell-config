var INFO =
<plugin name="hints-mouse-events" version="2.0"
        href="https://g.mozest.com/viewthread.php?tid=38908&amp;page=6#pid261071"
        summary="hints mouse events: add hints to trigger mouse over/move/out event"
        xmlns={NS}>
    ...
    添加两个扩展的hint模式：
        ...
        <note>settimeout不是每次都能象想象的那么工作</note>
    </p>
</plugin>;

dactyl.execute("set eht+=[hr]:*");
